...
def calcul_amplitude():
    ...
    for i in range(len(liste_valeurs_j)):
        ...
        for k in range(360):
            O34 = k*pi/180
            # Mélanie # même remarque qu'a la chaine 1, beta sert à ça je
            L.append(zero_par_secante(beta*pi/180, pi, O34, 10**-6, f2, j))
...
# nous avons besoin d'avoir les composantes de GE dans la suite
GE = vecteur_GE(O34)
...
# on cherche a trouver un debattement valant 105 degres à 2 degres pres et en deduire la valeur de j correspondante.
